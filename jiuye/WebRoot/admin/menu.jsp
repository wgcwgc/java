	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	            ...
	            <li><a href='<%=path %>/stuMana.action' target='main'>学生用户管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>招聘会---管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items2_1")'><b>招聘文档管理</b></dt>
	        <dd style='display:block' class='sitem' id='items2_1'>
	          <ul class='sitemu'>
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items3_1")'><b>就业新闻管理</b></dt>
	        <dd style='display:block' class='sitem' id='items3_1'>
	          <ul class='sitemu'>
