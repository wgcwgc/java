                              ...
                              <div class="c1-body">
                                  ...
                                  <div class="c1-bline" style="padding:7px 0px;">
                                       <div class="f-left">
                                            ...
                                            <a href="<%=path %>/newsDetailQian.action?newsId=<s:property value="#news.newsId"/>" title=""><span style=""><s:property value="#news.newsTitle"/></span></a>
                                       </div>
                                       <div class="f-right"><s:property value="#news.newsDate"/></div>
                                       <div class="clear"></div>
                                  </div>
                                  </s:iterator>
								  <div class="pg-3">
